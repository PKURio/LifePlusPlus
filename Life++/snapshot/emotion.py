...
emotions = {"anger": 1, "disgust": 2, "fear": 3, "happiness": 4, "neutral": 5, "sadness": 6, "surprise": 7}
...
try:
    ...
    dic = qrcont["faces"][0]["attributes"]["emotion"]
    emotion = sorted(dic.items(), key=lambda d: d[1])[-1][0]
    print emotions[emotion] + 10
